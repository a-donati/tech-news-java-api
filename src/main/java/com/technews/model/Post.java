...
public class Post implements Serializable {
    ...
    //    signal to JPA that variable cannot be null in db
    @NotNull
//    temporal - allows the use of type Date in the db, signal to JPA that the fields will house this datatype
    @Temporal(TemporalType.DATE)
    @Column(name = "posted_at")
    private Date postedAt = new Date();

    @NotNull
//   specify how date is persisted to DB
    @Temporal(TemporalType.DATE)
